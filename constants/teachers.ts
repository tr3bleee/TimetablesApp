...
export const TEACHERS: TeacherInfo[] = [
  ...
  { id: 34, fio: "Зайцева А.", position: null },
  { id: 12, fio: "Золотов Н.", position: null },
  { id: 35, fio: "Ишниязова А.", position: null },
  { id: 33, fio: "Качанова", position: null },
  { id: 15, fio: "Крупенко А.", position: null },
  { id: 26, fio: "Куратор", position: null },
